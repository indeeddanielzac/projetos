...
## [Resumo]{style="color:#263478"}

Bellabeat é uma empresa de tecnologia que fabrica produtos inteligentes focados na saúde. Eles oferecem diferentes *smart devices* que *coletam dados sobre atividade, sono, estresse e saúde reprodutiva* para
capacitar as mulheres com conhecimento sobre sua própria saúde e hábitos.

O aplicativo Bellabeat fornece aos usuários dados de saúde relacionados à atividade, sono, estresse, ciclo menstrual e hábitos de *mindfulness*. Esses dados podem ajudar os usuários a entender melhor seus hábitos
atuais e tomar decisões saudáveis. O aplicativo Bellabeat se conecta à sua linha de produtos de bem-estar inteligentes

## [Perguntas]{style="color:#263478"}
...
-   conferir a estrutura dos dados ;
...
-   Juntar os dados em apenas um conjunto
...
-   Iremos verificar se a média de minutos gastos em cada tipo de
    atividade;
...
Parameter1           |          Parameter2 |     r |        95% CI | t(408) |     p
---------------------|---------------------|-------|---------------|--------|------
